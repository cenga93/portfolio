...
var Testimonials = /*#__PURE__*/function () {
  ...
  _createClass(Testimonials, [{
    ...
    value: function slider() {
      var testimonialsWrapper = ".testimonials--splide";
      var sliderConfig = {
        type: "loop",
        perPage: 3,
        perMove: 1,
      ...
      if (testimonialsWrapper) {
        ...
        var testimonialsSlider = new Splide(testimonialsWrapper, sliderConfig); // mounting testimonials slider
...
var ContactValidation = /*#__PURE__*/function () {
...
document.addEventListener('DOMContentLoaded', function () {
  var testimonialsWrapper = document.querySelector(".testimonials");
